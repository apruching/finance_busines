...
<body>
    ...
    <div class="main-banner header-text" id="top">
        <div class="Modern-Slider">
            ...
            <?php
            require_once 'db.php';
            $get_banner_query = "SELECT * FROM bannners WHERE active_status= 1";
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="left-content">
                        ...
                        $after_assoc_fun_head = mysqli_fetch_assoc($from_db);
                        ?>
                        <span><?= $after_assoc_fun_head['sub_head'] ?></span>
                        <h2><?= $after_assoc_fun_head['white_head'] ?> <em><?= $after_assoc_fun_head['green_head'] ?></em></h2>
                        <p><?= $after_assoc_fun_head['para_one'] ?>
                            <br><br><?= $after_assoc_fun_head['para_two'] ?>
                        </p>
                        <a href="" class="filled-button">Read More</a>
                    </div>
                </div>
                        ...
                        ?>
                            <div class="col-md-6">
                                <div class="count-area-content">
                                    ...
                                    <div class="count-title"><?= $fun_items['fun_item_head'] ?></div>
                                </div>
                            </div>
                        <?php endforeach ?>
                    </div>
